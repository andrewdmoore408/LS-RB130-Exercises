...
Notes: return value could be an array of the numbers which were generated on each iteration. That would best allow for chaining if desired and mimics how Range#step works.

=end

def step(starting, ending, delta)
  values = []
...
p step(1, 21, 4) { |num| puts "num is #{num}" }